...
- **双语界面**：内置中文和英文支持
- **自动检测**：根据浏览器语言自动切换界面语言
- **可扩展**：支持自定义语言包，轻松添加更多语言
- 详见：[语言配置说明](Docs-Tools/语言配置说明.md) | [Language Configuration](Docs-Tools/Language-Configuration.md)
...
详细配置参考：[配置模板](NamBlog.API/wwwroot/config/config.json.template) | [配置系统说明](Docs-Tools/配置系统说明.md) | [Configuration Guide](Docs-Tools/Configuration-Guide.md)
